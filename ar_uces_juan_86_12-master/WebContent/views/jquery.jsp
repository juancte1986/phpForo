...
// 								aux +=  "</u>"
								var json = JSON.parse(JSON.stringify({"something":{"id":1,"value":"cónyuge"}}));
				...
				$("#ajaxPostButton").click(
						function() {
							...
							something.user = 'juan'
							$.ajax({
								url : '<c:url value="/services/processLogin" />',
								type : "POST",
	...
	<body>
		...
		<input type="submit" id="ajaxPostButton" value="Crear Something" /><br/>
